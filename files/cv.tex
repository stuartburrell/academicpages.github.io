...
%\textbf{The dimensions of inhomogeneous self-affine sets (with J.M. Fraser)}, \hfill July 2018\\ \emph{in preparation.}\\ 
...
All available student feedback data is included  reported on a scale of 1 (excellent) to 5 (poor) in the cateogires of Explanation (E), Organisation (O) and Availability (A).\\
